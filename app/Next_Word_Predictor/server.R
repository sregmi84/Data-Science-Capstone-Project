...
### Load the n-gram frequencies (generated by "build_ngrams.R")
initialPrediction <- readRDS("./data/startNextWordPredictor.RData")
freq2ngram <- readRDS("./data/bigram.RData")
freq3ngram <- readRDS("./data/trigram.RData")
freq4ngram <- readRDS("./data/quadgram.RData")

### Load profane words file - used for cleaning input
